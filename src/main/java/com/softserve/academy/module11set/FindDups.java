...
public class FindDups {
	...
	public static void main(String[] args) {
		...
		*/
		...
		//
		//Employee ivan1 = new Employee(123, "Ivan");
		//Employee ivan2 = new Employee(123, "Ivan");
		//System.out.println("ivan1 hash = " + ivan1.hashCode());
		//System.out.println("ivan2 hash = " + ivan2.hashCode());
		//
		//
		boolean b;
